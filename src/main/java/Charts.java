...
public class Charts {
	...
	private static double timeStep = 0.001; //шаг построения графика 20т за период ��� ������������� ��� 80 �. �� ������
  ...
  /**
   * Добавляет в указанный аналоговый сигнал новый график
   * @param name - имя добавляемого сигнала
   * @param chartNumber - номер графика
   * @param number - порю номер сигнала
   */
